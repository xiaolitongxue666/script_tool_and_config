...
# 插件配置
# ============================================
# Fish-like 体验插件（自动安装，如果未安装会被忽略）
# 注意：zsh-syntax-highlighting 必须放在最后
plugins=(
  git
  docker
  kubectl
