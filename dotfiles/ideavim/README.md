...
```bash
cd script_tool_and_config/dotfiles/ideavim
chmod +x install.sh
./install.sh
```
...
```bash
# 复制配置文件到用户目录
cp script_tool_and_config/dotfiles/ideavim/.ideavimrc ~/.ideavimrc
```

## 配置文件位置

- **配置文件**: `~/.ideavimrc`
- **项目配置**: `script_tool_and_config/dotfiles/ideavim/.ideavimrc`
