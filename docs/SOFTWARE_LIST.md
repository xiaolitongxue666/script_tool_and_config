...
run_once_install-clangd               ← Layer 3（clangd 二进制；无 GUI 也可；扩展见 CURSOR_CLANGD.md）
...
| Layer 3 | `run_once_install-clangd` | clangd 语言服务二进制（不装 Cursor；扩展见 [CURSOR_CLANGD.md](CURSOR_CLANGD.md)） | all |
