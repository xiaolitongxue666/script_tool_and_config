...
if [ "$USE_RSYNC" = true ]; then
    ...
    rsync -avz --progress \
      ...
      --exclude='scripts/tools/project_tools/cpp_project_generator/src/' \
      --exclude='scripts/tools/project_tools/cpp_project_generator/build/' \
      --exclude='scripts/tools/project_tools/cpp_project_generator/CMakeLists.txt' \
      --exclude='scripts/tools/project_tools/cpp_project_generator/.gitignore' \
      --exclude='scripts/linux/patch_examples/*.bak' \
      --exclude='scripts/tools/auto_edit_redis_config/redis.conf.bak' \
...
scripts/tools/project_tools/cpp_project_generator/src/
scripts/tools/project_tools/cpp_project_generator/build/
scripts/tools/project_tools/cpp_project_generator/CMakeLists.txt
scripts/tools/project_tools/cpp_project_generator/.gitignore
scripts/linux/patch_examples/*.bak
scripts/tools/auto_edit_redis_config/redis.conf.bak
scripts/**/test_*.sh
scripts/**/TEST_*.md
scripts/**/*_test.sh
scripts/**/*_test_*.sh
